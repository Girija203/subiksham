    ...
    <div class="wrapper">
        ...
        <div class="sidebar-wrapper" data-simplebar="true">
            ...
            />  --}}
                ...
                <div>
                    {{-- <h4 class="logo-text">Subiksham Academy</h4> --}}
                </div>
            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    <a href="{{route('home')}}">
                        <div class="parent-icon"><i class="fadeIn animated bx bx-world"></i></div>
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="{{route('image.category')}}"><i class="bx bx-radio-circle"></i>Image Category </a>
                        </li>
                        <li>
                            <a href="{{route('gallery.index')}}"><i class="bx bx-radio-circle"></i>Gallery </a>
                        </li>
                ...
                <li>
                    <a href="javascript:;" class="has-arrow">
                        <div class="parent-icon"><i class="fadeIn animated bx bx-video"></i></div>
                        <div class="menu-title">Courses</div>
                    </a>
                    <ul>

                        {{-- <li>
                            <a href="#"><i class="bx bx-radio-circle"></i>Course category
                            </a>
                        </li> --}}
                        <li>
                            <a href="{{route('course.index')}}"><i class="bx bx-radio-circle"></i>Course list </a>
                        </li>
                ...
                <li>
                    <a href="javascript:;" class="has-arrow">
                        ...
                        <div class="menu-title">Braches</div>
                    </a>
                    <ul>
                        <li>
                            <a href="{{route('branch.index')}}"><i class="bx bx-radio-circle"></i> Branch List </a>
                        </li>
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="{{route('contact.index')}}"><i class="bx bx-radio-circle"></i> Contact List </a>
                        </li>
